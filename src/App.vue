  ...
  <div id="app" class="antialiased text-gray-800">
    ...
    >
      ...
      <div class="max-w-5xl mx-auto lg:py-32 py-2">
        ...
        <div
          class="flex items-center flex-wrap justify-start max-w-2xl lg:mx-0 mx-auto"
        >
          <div class="lg:pr-5 w-full lg:w-1/2 mb-4 lg:mb-0">
            ...
            <a
              href="#"
              class="transition bg-white px-10 py-3 rounded font-bold hover:bg-gray-500 block w-full text-center border-2 border-white"
              >Explore.</a
            >
          </div>
          <div class="lg:pl-5 w-full lg:w-1/2">
            ...
            <a
              href="#"
              class="transition bg-transparent px-10 py-3 rounded text-white font-bold hover:bg-gray-800 block w-full text-center border-2 border-white"
              >Host.</a
            >
          </div>
          <div></div>
    ...
    <div class="max-w-5xl mx-auto lg:py-16 lg:px-0 px-4">
      <h3 class="font-bold bold text-2xl mb-4 leading">
      ...
      <form action="#" class="lg:mb-16 mb-10">
        <div class="flex items-start justify-start flex-wrap">
          ...
          <div class="lg:w-1/3 w-full lg:px-2 mb-4 lg:mb-0">
            <label for="check_in-check_out" class="label"
          ...
          <div class="lg:w-1/3 w-full lg:pl-2">
            ...
            <div class="relative">
              <select name="" id="guests" class="input select">
      ...
      <h3 class="font-bold bold text-2xl lg:mb-2 mb-4 leading-none">
      ...
      <section class="flex items-start flex-wrap justify-between lg:my-10 my-6">
        ...
        <article class="lg:w-1/3 w-full lg:pr-4 lg:mb-0 mb-6">
          <img class="object-cover rounded w-full" src="./1.jpg" alt="" />
        ...
        <article class="lg:w-1/3 w-full lg:px-2 lg:mb-0 mb-6">
          ...
          <p class="text-gray-700 font-light text-sm leading-snug">
            I had a great phone conversation with agent Maryory. She was really
            kind and sweet. She understood me and really help me. I just wanna
            congratulate her and airbnb for the service
          </p>
          <div class="flex items-center justify-start my-4">
            <img
              class="w-12 h-12 rounded-full flex-shrink-0"
        ...
        <article class="lg:w-1/3 w-full lg:pl-4 lg:mb-0 mb-6">
          ...
          <p class="text-gray-700 font-light text-sm leading-snug">
            Good as expected. The host was awesome and the place was good too.
          </p>
          <div class="flex items-center justify-start my-4">
            <img
              class="w-12 h-12 rounded-full flex-shrink-0"
      ...
      <section
        class="flex items-start flex-wrap justify-between lg:my-8 my-6 border-b border-gray-300 pb-8"
      >
        <div class="w-1/3 w-full lg:pr-4 lg:mb-0 mb-6">
          <svg
            class="w-8 h-8"
            viewBox="0 0 24 24"
            fill="#60B6B5"
        ...
        <div class="w-1/3 w-full lg:px-2 lg:mb-0 mb-6">
          <svg
            class="w-8 h-8"
            viewBox="0 0 24 24"
            role="presentation"
          ...
          <p class="font-bold mt-3 mb-1">Global hospitality standard</p>
          <p class="text-gray-700 font-light text-sm leading-snug">
        ...
        <div class="w-1/3 w-full lg:pl-4">
          <svg
            class="w-8 h-8"
            viewBox="0 0 24 24"
            role="presentation"
      ...
      <section class="flex items-start flex-wrap justify-between lg:my-8 my-6">
        <a
          href="#"
          class="lg:w-1/4 md:w-1/2 w-full lg:pr-2 md:pr-2 lg:mb-0 mb-6"
        >
          <img src="./just-booked-1.jpg" class="object-cover w-full" />

          <p class="uppercase text-gray-600 text-xs font-bold pt-2">
            Entire House <span aria-hidden="true">•</span> Joshua Tree
          </p>
          <h4 class="font-medium my-1 text-lg leading-snug">
        ...
        <a
          href="#"
          class="lg:w-1/4 md:w-1/2 w-full lg:px-1 md:px-1 lg:mb-0 mb-6"
        >
          <img src="./just-booked-2.jpg" class="object-cover w-full" />
          <p class="uppercase text-gray-600 text-xs font-bold pt-2">
        ...
        <a
          href="#"
          class="lg:w-1/4 md:w-1/2 w-full lg:px-1 md:px-1 lg:mb-0 mb-6"
          ><img src="./just-booked-3.jpg" class="object-cover w-full" />
          <p
            class="uppercase text-gray-600 text-xs font-bold pt-2 leading-snug"
          >
            Earth house <span aria-hidden="true">•</span>
          </p>
          <h4 class="font-medium my-1 text-lg">Underground Hyegge</h4>
          ...
          <div class="flex items-center">
            ...
            <p class="text-xs text-gray-600">
              552 <span aria-hidden="true">•</span> Superhost
            </p>
          </div></a
        >
        <a href="#" class="lg:w-1/4 md:w-1/2 lg:pl-2 md:pl-2"
          ><img src="./just-booked-4.jpg" class="object-cover w-full" />
          <p class="uppercase text-gray-600 text-xs font-bold pt-2">
            Entire house <span aria-hidden="true">•</span> Pioneer town
          </p>
          <h4 class="font-mediummy-1 text-lg leading-snug">Off grid itHouse</h4>
...
=======
<div id="app" class="antialiased text-gray-800">
    <header  class="relative bg-no-repeat bg-cover lg:bg-center p-6 bg-top-right ">
        <a href="/">
            <h1>
                <span class="sr-only">AirBnb</span>
       ...
       <h2 class="lg:text-5xl text-4xl font-semibold text-white leading-none mb-4">Book a trip. Host travels. All on Airbnb.</h2>
          <div class="flex items-center flex-wrap justify-start max-w-2xl lg:mx-0 mx-auto">
                <div class="lg:pr-5 w-full lg:w-1/2 mb-4 lg:mb-0">
                  ...
                  <a href="#" class="transition bg-white px-10 py-3 rounded font-bold hover:bg-gray-500 block w-full text-center border-2 border-white">Explore.</a>
                </div>
                <div class="lg:pl-5 w-full lg:w-1/2 ">
                  <p class="text-white mb-2 tracking-wide">Earn money from your extra space.</p>
                  <a href="#" class="transition bg-transparent px-10 py-3 rounded text-white font-bold hover:bg-gray-800 block w-full text-center border-2 border-white">Host.</a>
                </div>
                <div></div>
          </div>
      </div>
  ...
  <div class="max-w-5xl mx-auto lg:py-16 lg:px-0 px-4">
    <h3 class="font-bold bold text-2xl mb-4 leading">Book unique homes and experiences.</h3>
    <form action="#" class="lg:mb-16 mb-10">
      <div class="flex items-start justify-start flex-wrap">
        <div class="lg:w-1/3 w-full lg:pr-2 mb-4 lg:mb-0">
          <label for="where" class="label">Where</label>
        ...
        <div class="lg:w-1/3 w-full lg:px-2 mb-4 lg:mb-0">
          <label for="check_in-check_out" class="label">Check in - Check Out</label>
          <input type="text" class="input" id="check_in-check_out" placeholder="mm/dd/yyyy" />
        </div>
        <div class="lg:w-1/3 w-full lg:pl-2">
          <label for="guests" class="label">Guests</label>
          <div class="relative">
    ...
    <h3 class="font-bold bold text-2xl  lg:mb-2 mb-4 leading-none">What guests are saying about homes in  the United States</h3>
    <div class="flex lg:items-center items-start">
    ...
    <section class="flex items-start flex-wrap justify-between lg:my-10 my-6">
      ...
      <article class="lg:w-1/3 w-full lg:pr-4 lg:mb-0 mb-6">
        ...
        <div class="flex items-center justify-start my-4">
          <img class="w-12 h-12 rounded-full flex-shrink-0" src="./jeff.jpg" alt="">
          <div class="flex-1 pl-4 text-sm">
             <p class="font-semibold leading-none">Jeff</p>
             <p>United States</p>
          </div>
      ...
      <article class="lg:w-1/3 w-full lg:px-2 lg:mb-0 mb-6">
        ...
        <p class="text-gray-700 font-light text-sm leading-snug">I had a great phone conversation with agent Maryory. She was really kind and sweet. She understood me and really help me. I just wanna congratulate her and airbnb for the service</p>
        <div class="flex items-center justify-start my-4">
          <img class="w-12 h-12 rounded-full flex-shrink-0" src="./lesley.jpg" alt="">
          <div class="flex-1 pl-4 text-sm">
            <p class="font-semibold leading-none">Lesley</p>
            <p>United Kingdom</p>
          </div>
      ...
      <article class="lg:w-1/3 w-full lg:pl-4 lg:mb-0 mb-6">
        ...
        <p class="text-gray-700 font-light text-sm leading-snug">Good as expected. The host was awesome and the place was good too.</p>
        <div class="flex items-center justify-start my-4">
          <img class="w-12 h-12 rounded-full flex-shrink-0" src="./denise.jpg" alt="">
          <div class="flex-1 pl-4 text-sm">
            <p class="font-semibold leading-none">Denise</p>
            <p>Canada</p>
          </div>
    ...
    <h3 class="font-bold bold text-2xl lg:mb-2 mb-4 leading-none pb-4 border-b border-gray-300">Travelling with Airbnb</h3>
...
>>>>>>> ed64e147a4f1bb968d02db7cbfbd6de95f7d8eb3
  </div>
</div>
</template>
...
header {
  background-image: url("../airbnb-home.jpg");
}
.transition {
